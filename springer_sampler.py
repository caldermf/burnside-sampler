...
This implements the sampling algorithm from Section 5 of our paper:
...
Algorithm (one step of chain from permutation w):
    1. Sample a \in U_w uniformly (the stabilizer of wB)
    2. Compute Jordan form of a (eigenvalues are all 1)
    3. Sample a flag from the Springer fiber of a:
